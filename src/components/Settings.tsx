    ...
    <div className="settings-stage">
      ...
      <section className="section">
        ...
        <p className="pack-hint">
          可以放球队 Logo / 球星公仔 PNG 到素材文件夹,每个子文件夹一个包
        </p>
      </section>
      ...
      <section className="section">
        ...
        <div className="mode-row">
          ...
          <label>
            ...
            <small>ESPN 实时拉取,30s 一刷,三分/暴扣自动推送</small>
          </label>
        </div>
      </section>
      ...
      <section className="section">
        ...
        <div className="toggle-row">
          ...
          <label className="toggle">
            ...
            <span>🔊 声音提示</span>
            <small>得分/暴扣/终场 8-bit 音效</small>
          </label>
          <label className="toggle">
            <input type="checkbox" checked={showWinProb} onChange={e => setShowWinProb(e.target.checked)} />
            <span>📈 显示胜率曲线</span>
            <small>比分板下方迷你 sparkline</small>
          </label>
        </div>
      </section>

      <section className="section">
        <h2>关注的球队（1-3 支 NBA 球队）</h2>
        <div className="search-box">
          <input
            type="text"
            placeholder="搜索球队 (Spurs / Knicks / Lakers ...)"
            value={search}
